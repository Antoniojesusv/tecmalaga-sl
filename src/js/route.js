function Route(features = {}) {
    ...
    if (validationSpa.isValidFeaturesRoute(features)) throw new appException({name: 'RouteFeaturesException', msg: 'the characteristics are not valid or are not of the string type'});
